(window.webpackJsonp=window.webpackJsonp||[]).push([[70],{340:function(M,j,L){"use strict";L.r(j);var N=L(269);customElements.define("uc-footer-social-links",class extends N.a{static get styles(){return N.b`:host {
        display: -webkit-box;
        display: -ms-flexbox;
        display: flex;
